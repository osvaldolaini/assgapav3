...
class ReasonEvents extends Component
{
    ...
    //Dados da tabela
    public $model = "App\Models\Admin\Configs\ReasonEvent"; //Model principal
    ...
    {
        return view('livewire.admin.configs.reason-events', [
    ...
    public function showModalRead($id)
    {
        ...
        if (isset($id)) {
            $data = ReasonEvent::where('id', $id)->first();
            $this->detail = [
                'Criada'            => $data->created,
    ...
    //UPDATE
    public function showModalUpdate(ReasonEvent $reasonEvent)
    {
        $this->resetAll();

        $this->model_id         = $reasonEvent->id;
        $this->title            = $reasonEvent->title;
