...
class AmbienceTenants extends Component
{
    ...
    public $columnsInclude = 'title,type,active';
    public $searchable = 'title,searchType->type'; //Colunas pesquisadas no banco de dados
    ...
    {
        return view('livewire.admin.configs.ambience-tenants', [
    ...
    public function showModalRead($id)
    {
        ...
        if (isset($id)) {
            $data = AmbienceTenant::where('id', $id)->first();
            $this->detail = [
                'Criada'            => $data->created,
    ...
    //UPDATE
    public function showModalUpdate(AmbienceTenant $ambienceTenant)
    {
        $this->resetAll();

        $this->model_id         = $ambienceTenant->id;
        $this->title            = $ambienceTenant->title;
        $this->type            = $ambienceTenant->type;
