...
class DeleteLocations extends Component
{
    use WithPagination;
    ...
    public $columnsInclude = 'location_date,locations.active,locations.deleted_because,locations.deleted_at,partner,ambience,ambiences.title as ambiente,partners.name as locatario';
    ...
    {
        return view('livewire.admin.locations.delete-locations', [
   ...
   public function buttonActive($id)
   {
    ...
    private function getData()
    {
            ...
            $query = $query->where('locations.active', 2);
