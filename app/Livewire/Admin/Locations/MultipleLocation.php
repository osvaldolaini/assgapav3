...
class MultipleLocation extends Component
{

    public $rules;
    public $dependents;

    public $breadcrumb_title = 'LOCAÇÃO MÚLTIPLA';
    //Calendar
    public $events = [];
    ...
    public function render()
    {
        ...
        return view('livewire.admin.locations.multiple-location');
    }

    public function clean($date)
    {
        $date = date('d/m/Y', $date);
        if (in_array( $date,$this->location_date)) {
            $this->location_date = array_values(array_diff($this->location_date, array($date)));
        }
    }
    ...
    public function insertDate($date)
    {
        ...
        $this->location_date = array_unique($this->location_date);
    }
    ...
    public function save_out()
    {
        ...
        $this->validate();
        foreach ($this->location_date as $date) {
