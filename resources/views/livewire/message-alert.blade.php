<div wire:model="alertSession" class="fixed z-50 w-80 top-24 sm:top-24 right-5 sm:right-5">
    ...
    @if (session('success'))
        <div id="alert-border-1"
            ...
            <button type="button" wire:click="$toggle('alertSession')"
    ...
    @if (session('warning'))
        <div id="alert-border-4"
            ...
            <button type="button" wire:click="$toggle('alertSession')"
                class="ml-auto -mx-1.5 -my-1.5 bg-yellow-50 text-yellow-500 rounded-lg focus:ring-2 focus:ring-yellow-400 p-1.5 hover:bg-yellow-200 inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:text-yellow-400 dark:hover:bg-gray-700"
