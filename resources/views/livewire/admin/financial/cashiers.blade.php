                    ...
                    <div class="inline-block min-w-full align-middle md:px-6 lg:px-8">
                        <div class="overflow-hidden border border-gray-200 dark:border-gray-700 sm:rounded-lg">
                            <table style="width:100%" class='min-w-full divide-y divide-gray-200 dark:divide-gray-700'>
                                ...
                                <tbody
                                    class="uppercase bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                            ...
                                            <tr wire:key="data-row-{{ $data->id }}">
                                                ...
                                                <td
                                                    class="py-1.5 px-4 text-sm font-normal text-center
                                                       flex-nowrap">
                                                    @if ($data->active == 1)
                                                        @livewire('admin.financial.voucher', ['data' => $data, 'type' => 'cashier'], key($data->id))
                                                    @endif
                                                </td>
                                                <td
