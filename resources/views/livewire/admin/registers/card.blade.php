    ...
    @foreach ($cards as $card)
        <div class="cartao" style="margin-top: 0px;">
            <div class="frente" style="border:double 0.2cm {{ $card['color'] }};  ">
                ...
                <div class="foto"><img style='width: 100%; height: 100%;'
                        src="{{ url('storage/partners/' . $card['image']) }}"></div>
                <div class="dados">
                    <table>
                        <tr>
            ...
            <div class="verso"
                ...
                <div class="assinatura">
                    <div style="text-align:center; float: left; width:6cm; ">
                        ...
                        <p style="text-decoration: uppercase;"><STRONG>{{ mb_strtoupper($config->president) }}</STRONG>
                        </p>
                    </div>
