<div>
            ...
            <div class="col-span-2 justify-items-end">
                @if ($partner_category_master == 'Sócio')
                    <x-table-register-buttons id="{{ $id }}" :card="true" :dependent="true"
                        :history="true" :discount="$discount">
    ...
    <fieldset class="grid grid-cols-4 gap-2 p-6 rounded-md dark:bg-gray-900">
        ...
        <form wire:submit="#" class="grid grid-cols-8 gap-2 col-span-full lg:col-span-3">
            ...
            @if ($partner_category_master == 'Dependente' or $seeResponsible == true)
                <div class="col-span-full sm:col-span-2">
                    ...
                    <Select wire:model.lazy="student"
                        class="w-full rounded-md focus:ring focus:ri dark:border-gray-700 dark:text-gray-900">
                        <option value="0">Não</option>
                        <option value="1">Sim</option>
                    </Select>
...
<div class="col-span-full sm:col-span-2">
    ...
    <Select wire:model="discount" class="w-full rounded-md focus:ring focus:ri dark:border-gray-700 dark:text-gray-900">
        <option value="1">Sim</option>
        <option value="0">Não</option>
...
<div class="col-span-full sm:col-span-4 {{ $pf_pj == 'pf' ? 'block' : 'hidden' }}">
    ...
    <input x-mask="999.999.999-99" placeholder="000.000.000-00" required
        class="w-full rounded-md focus:ring focus:ri dark:border-gray-700 dark:text-gray-900" wire:model="cpf">
    @error('cpf')
        <span class="text-red-500 error">{{ $message }}</span>
    @enderror
</div>
...
<div class="col-span-full sm:col-span-4 {{ $pf_pj == 'pj' ? 'block' : 'hidden' }}">
    ...
    <input x-mask="99.999.999/9999-99" placeholder="00.000.000/0000-00" required
        class="w-full rounded-md focus:ring focus:ri dark:border-gray-700 dark:text-gray-900" wire:model="cnpj">
    @error('cnpj')
        <span class="text-red-500 error">{{ $message }}</span>
    @enderror
</div>
...
<div class="col-span-full sm:col-span-2">
    ...
    <input x-mask="99999999-99" placeholder="00000000-00"
        class="w-full rounded-md focus:ring focus:ri dark:border-gray-700 dark:text-gray-900" maxlength="11"
        placeholder="saram_novo" wire:model="saram_novo">
</div>

<div class="col-span-full sm:col-span-4">
    <label class="text-sm" for="email">E-mail</label>
    <input type="email" class="w-full rounded-md focus:ring focus:ri dark:border-gray-700 dark:text-gray-900"
...
<div class="col-span-full sm:col-span-2">
    ...
    <div class="flex">
        <input type="text" wire:model="validity_of_card" x-mask="99/99/9999" placeholder="99/99/9999"
            class="w-full rounded-l-md focus:ring focus:ri dark:border-gray-700 dark:text-gray-900">
        <span class="flex items-center px-3 bg-green-700 pointer-events-none sm:text-sm rounded-r-md">
            <svg class="w-4 h-4 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                fill="currentColor" viewBox="0 0 20 20">
...
<div class="col-span-full sm:col-span-2">
    ...
    <input x-mask="99999-999" class="w-full rounded-md focus:ring focus:ri dark:border-gray-700 dark:text-gray-900"
...
<div class="col-span-full sm:col-span-6">
    ...
    <input class="w-full rounded-md focus:ring focus:ri dark:border-gray-700 dark:text-gray-900"
        placeholder="Rua, Av, Travessa, etc" wire:model="address" value="{{ old('address', $address ?? '') }}">
</div>
<div class="col-span-full sm:col-span-4">
    <label class="text-sm" for="number">Número</label>
    <input class="w-full rounded-md focus:ring focus:ri dark:border-gray-700 dark:text-gray-900" placeholder="nº"
        wire:model="number" value="{{ old('number', $number ?? '') }}">
</div>
<div class="col-span-full sm:col-span-4">
    <label class="text-sm" for="about">Bairro</label>
    <input class="w-full rounded-md focus:ring focus:ri dark:border-gray-700 dark:text-gray-900" placeholder="Bairro"
        wire:model="district" value="{{ old('district', $district ?? '') }}">
</div>
<div class="col-span-full sm:col-span-6">
    <label class="text-sm" for="city">Cidade</label>
    <input class="w-full rounded-md focus:ring focus:ri dark:border-gray-700 dark:text-gray-900" placeholder="Cidade"
        wire:model="city" value="{{ old('city', $city ?? '') }}">
</div>

<div class="col-span-full sm:col-span-2">
    <label class="text-sm" for="state">Estado</label>
    <input class="w-full rounded-md focus:ring focus:ri dark:border-gray-700 dark:text-gray-900" placeholder="UF"
        x-mask="aa" wire:model="state" maxlength="2" value="{{ old('state', $state ?? '') }}">
</div>
                                            ...
                                            <div class="flex items-center gap-3 cursor-pointer "
                                                ...
                                                <div class="avatar">
                                                    <div class="w-12 h-12 mask mask-squircle">
                                                        ...
                                                        @else
                                                            <picture>
                                                                <source srcset="{{ url('storage/logos/assgapa.png') }}" />
                                                                <source srcset="{{ url('storage/logo/assgapa.webp') }}" />
