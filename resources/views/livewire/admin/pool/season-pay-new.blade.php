            ...
            <fieldset class="grid items-start grid-cols-12 gap-2 py-6 rounded-md dark:bg-gray-900">
                ...
                @if ($partner_id)
                    ...
                    @if ($type)
                        ...
                        @if ($seasons->count() > 0 and $type == 'Diário')
                            <div class="col-span-full">
                                ...
                                <div class="flex justify-center w-full mb-5">
                                    <span wire:click="addRow"
                                        ...
                                        Adicionar pulseira <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 ml-2 "
                                ...
                                @foreach ($bracelets as $index => $row)
                                    <div
                                        class="grid grid-cols-4 gap-4 p-2 mb-1 bg-gray-200 border border-gray-900 rounded-lg sm:grid-cols-6 sm:gap-3 sm:mb-5 dark:bg-gray-800 dark:border-gray-500">
                                        <div
                                        ...
                                        <div class="col-span-1">
                                            ...
                                            <input type="text"
                                                wire:model.lazy="bracelets.{{ $index }}.number"
                                                placeholder="Número" required
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                            @error('bracelets.{{ $index }}.number')
                                                <span class="error">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="col-span-2">
                                            ...
                                            <input type="text"
                                                wire:model.lazy="bracelets.{{ $index }}.name"
                                                placeholder="Nome" required
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                            @error('bracelets.{{ $index }}.name')
                                                <span class="error">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="col-span-1"> <label for="contact"
                                                class="block text-sm font-medium text-gray-900 dark:text-white">*Temporada
                                            </label>
                                            <Select wire:model.lazy="bracelets.{{ $index }}.season_id" required
                                                wire:change="updateSeasonValue({{ $index }})"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                                <option value="">Selecione...</option>
                                                @foreach ($seasons as $season)
                                                    <option value="{{ $season->id }}">
                                            ...
                                            @error('bracelets.{{ $index }}.season_id')
                                                <span class="error">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    </div>
