            ...
            <div class="h-full py-2 bg-white rounded-2xl dark:bg-gray-700">
                <nav class="mt-3">
                    <div>
                        ...
                        <x-link-simple url="multiple" active="*multiplas-locaçoes*" role='11' :pages="$pages">
                            <span class="text-left">
                                <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                    ...
                                    <path d="M18.5 15.6429L17 17.1429" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <circle cx="17" cy="17" r="5" stroke="currentColor"
                        ...
                        @if (in_array(9, $pages) == true)
                            ...
                            <div id="pool"
                                class="z-10 justify-start hidden w-full bg-white divide-gray-100 shadow rounded-es-lg dark:bg-gray-700 ">
                                <ul class="mt-0 ml-5 text-sm text-gray-700 rounded-ee-sm dark:text-gray-200"
                        ...
                        @if (in_array(5, $pages) == true)
                            ...
                            <div id="dropdownMaterial"
                                class="z-10 justify-start hidden w-full bg-white divide-gray-100 shadow rounded-es-lg dark:bg-gray-700 ">
                                <ul class="mt-2 ml-5 text-sm text-gray-700 rounded-ee-sm dark:text-gray-200"
                        ...
                        @if (in_array(1, $pages) == true)
                            ...
                            <div id="configs"
                                ...
                                <ul class="mt-0 ml-5 text-sm text-gray-700 rounded-ee-sm dark:text-gray-200"
                                    ...
                                    <x-link-dropdown url="partner-categories"
                                        active="configurações-categorias-de-socio">
                                        <svg class="w-6 h-6 mr-2" viewBox="0 0 24 24"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.4"
                                                d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z"
