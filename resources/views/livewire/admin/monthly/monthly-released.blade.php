<div
    class="flex flex-col items-center justify-between px-4
                space-y-3 md:flex-row md:space-y-0 md:space-x-4 pt-3">
    <div class="w-full py-2 px-4 shadow-md bg-green-200 rounded-t-md ">
        <div class="w-full flex justify-between border-bottom">
            <h3 class="mb-5 text-2xl font-bold tracki text-gray-600">Liberadas</h3>
        </div>
