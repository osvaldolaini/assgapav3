<div
    class="flex flex-col items-center justify-between px-4 mb-5
                space-y-3 md:flex-row md:space-y-0 md:space-x-4">
    <div class="w-full py-2 px-4 shadow-md bg-red-200 rounded-t-md">
        <div class="grid grid-cols-8 gap-4 text-gray-600 ">
            <div class="col-span-6 justify-items-start">
                <h3 class="mb-5 text-2xl font-bold tracki text-red-500">Não pagas</h3>
            </div>
            <div class="col-span-2 flex justify-end space-x-2">
                <button wire:click="modalCreate()" class="btn btn-info text-white">Criar
                ...
                <button wire:click="paid()" class="btn btn-success text-white">Pagar
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 " fill="currentColor" xviewBox="0 0 24 24">
                        <path
                            d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1.41 16.09V20h-2.67v-1.93c-1.71-.36-3.16-1.46-3.27-3.4h1.96c.1 1.05.82 1.87 2.65 1.87 1.96 0 2.4-.98 2.4-1.59 0-.83-.44-1.61-2.67-2.14-2.48-.6-4.18-1.62-4.18-3.67 0-1.72 1.39-2.84 3.11-3.21V4h2.67v1.95c1.86.45 2.79 1.86 2.85 3.39H14.3c-.05-1.11-.64-1.87-2.22-1.87-1.5 0-2.4.68-2.4 1.64 0 .84.65 1.39 2.67 1.91s4.18 1.39 4.18 3.91c-.01 1.83-1.38 2.83-3.12 3.16z" />
                    </svg>
                    ...
                    <div class="indicator w-full">
                        ...
                        <div class="flex  w-full">
                            ...
                            <label for="monthly-{{ $item->id }}-s"
                                class="inline-flex peer-checked:hidden items-center
                                justify-between w-full text-gray-500 bg-gray-200 border-2
                                border-gray-200 rounded-lg cursor-pointer peer-checked:bg-blue-500
                                 peer-checked:border-blue-500 hover:text-gray-600
                                 peer-checked:text-gray-600 hover:bg-blue-500
                                 ">
                                <div class="flex h-full items-center justify-center p-0 m-0 ">
                            ...
                            <label for="monthly-{{ $item->id }}-s"
                                class="hidden peer-checked:inline-flex items-center
                                        justify-between w-full text-gray-500 bg-gray-200 border-2
                                    border-gray-200 rounded-lg cursor-pointer peer-checked:bg-blue-500
                                    peer-checked:border-blue-500 hover:text-gray-600
                                    peer-checked:text-gray-600 hover:bg-blue-500
    ...
    <x-dialog-modal wire:model="showModalPay">
        ...
        <x-slot name="content">
            <form wire:submit="store">
                <div class="grid gap-2 mb-1 grid-cols-2 sm:gap-4 sm:mb-5">
                    ...
                    <div class="col-span-full sm:col-span-1 text-left">
