<div>
    <div class="p-0 tooltip tooltip-top" data-tip="Observações">
        <button wire:click="openObs() "
    ...
    <x-dialog-modal wire:model="showModal">
        <x-slot name="title">Observações</x-slot>
        <x-slot name="content">
        ...
        <x-slot name="footer">
            <x-secondary-button wire:click="$toggle('showModal')" class="mx-2">
                Fechar
            </x-secondary-button>
        </x-slot>
    </x-dialog-modal>
