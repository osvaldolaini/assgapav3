<div>
    <x-breadcrumb>
        <div class="grid grid-cols-8 gap-4 text-gray-600 ">
            ...
            <div class="flex col-span-2 justify-items-end">
                ...
                <div class="grid grid-cols-12 col-span-6 gap-2">
                    <div class="col-span-12 ">
                        ...
                        <div class="grid grid-cols-1 gap-4 mb-1">
                            <fieldset class="w-full col-span-1 space-y-1 dark:text-gray-100" wire:ignore>
                    ...
                    @if ($partner_id)
                        ...
                        @if ($ambience_id)
                            ...
                            <div class="col-span-12 ">
                                ...
                                <textarea class="w-full rounded-md focus:ring focus:ri dark:border-gray-700 dark:text-gray-900"
