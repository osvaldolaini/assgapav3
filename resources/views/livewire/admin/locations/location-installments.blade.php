        ...
        <div class="stats shadow mb-0">
            ...
            <div class="stat">
                <div class="stat-figure text-secondary">
                    @if ($installments->count() < 3 && $location->remaining > 0)
                    ...
                    <div class="min-w-full overflow-hidden rounded-lg shadow">
                        <div class="grid grid-cols-12 space-x-0 gap-0 text-center bg-gray-200 p-2">
                            <div class="py-2 pl-1 flex font-semibold items-center justify-start col-span-1">
                                Recibo</div>
                            <div class="py-2 pl-1 flex font-semibold items-center justify-start col-span-2">Parcela</div>
                            <div class="py-2 pl-1 flex font-semibold items-center justify-center col-span-2">Valor</div>
                            <div class="py-2 pl-1 flex font-semibold items-center justify-center col-span-3">Vencimento / Pagamento</div>
                            <div class="py-2 pl-1 flex font-semibold items-center justify-center col-span-2">Forma de pagamento</div>
                            <div class="py-2 pl-1 flex font-semibold items-center justify-center col-span-2">Opções</div>
                        </div>
                        <div >
