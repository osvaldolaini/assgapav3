<div>
    ...
    bg-blue-900 bg-opacity-50 backdrop-brightness-50 backdrop-blur-sm " wire:loading>
        ...
        shadow-md sm:py-8 sm:px-12 bg-blue-900 text-gray-100 mx-auto">
            ...
            <h2 class="text-2xl font-semibold leadi tracki">Carregando<span class="loading loading-dots loading-xs"></span></h2>
            <p class="flex-1 text-center text-white">Por favor aguarde.</p>
        </div>
    </div>
</div>
